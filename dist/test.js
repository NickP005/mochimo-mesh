...
async function testMochimoRosettaClient() {
    ...
    try {
        ...
        */
        ...
        // convert to hex   
        const txManager = new wallet_manager_1.TransactionManager(client, "c54572cb24e810fc2285aa4f310ce07ad3158a34e7fe8fc63287130935189800", // wots_seed
        ...
        const txResponse = await txManager.sendTransaction(1, // amount
        500 // fee
        );
    }
    catch (error) {
